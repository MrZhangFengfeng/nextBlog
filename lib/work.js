  ...
  return [
    {
      id: "1",
      title: "能量周秒杀",
      technologyStack: "微信小程序、React、Mobx",
      poster:
    ...
    },
    {
      id: "2",
      title: "春节集卡",
      technologyStack: "React、Mobx、animejs、node",
      poster:
    ...
    },
    {
      id: "3",
      title: "国庆点亮城市",
      technologyStack: "React、Mobx、canvas、animation",
      poster:
    ...
    },
    {
      id: "4",
      title: "周周乐",
      technologyStack: "微信小程序、animation",
      poster:
    ...
    },
    {
      id: "5",
      title: "划点游戏",
      technologyStack: "React、Mobx、canvas",
      poster: "https://pages.c-ctrip.com/union/2021/1024task/xcxpic.jpg",
    },
    {
      id: "6",
      title: "抽奖零元游",
      technologyStack: "React、微信小程序、canvas",
      poster:
    ...
    },
    {
      id: "7",
      title: "CMS",
      technologyStack: "React、Next、Ant Design",
      poster: "/images/cms.png",
    },
    {
      id: "8",
      title: "代开发平台",
      technologyStack: "React、Next",
